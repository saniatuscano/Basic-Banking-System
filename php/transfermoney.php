                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="center "><a href="userdetails.php?c_id=<?php echo $rows['c_id']; ?>"> <button type="button" class="btn #ec407a pink lighten-1">Transfer Money<i class="material-icons right">attach_money</i></button></a></td>
                                    </tr>
                            <?php
                                }
                            }
